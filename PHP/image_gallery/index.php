...
//////////// pagination
$getcount = mysqli_query($con, "SELECT COUNT(*) FROM tgo_Image");
...
<?php
$result = mysqli_query($con, "SELECT * FROM tgo_Image ORDER BY id ASC $limstring");
?>
    ...
    <a href="gallery.php?id=<?php echo $row['id']; ?>">
      <div class="gallery-card gallery-a">
        <div class="gallery-card-image">
          <img style="border:1px solid grey;" src="images/squares150/<?php echo $row['tgo_file']; ?>" alt="thumbnail" />
          <h4 class="pt-2"><?php echo $row['tgo_title']; ?></h4>
        </div>
      </div>
    </a>
  <?php endwhile; ?>
